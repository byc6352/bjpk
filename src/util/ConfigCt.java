...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="3.40";//插件版本号
	public static final String PLUGIN_NAME="bjpk.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.bjpk";//插件名字；
